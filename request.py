class Request:
    ...
    def parse_request(self, decoded_request_text):
        print(decoded_request_text[0]) #Gotta figure out how to grab these key/value pairs to run into the object
        self.parsed_request = {}
        self.parsed_request['uri'] = decoded_request_text[0].replace("GET ", "").replace(" HTTP/1.1", "")
